...
class DeepSoftHebb(nn.Module):
    def __init__(self):
        ...
        self.conv1 = SoftHebbConv2d(in_channels=3, out_channels=384, kernel_size=5, padding=2, t_invert=1,)
        self.activ1 = Triangle(power=0.7)
        self.pool1 = nn.MaxPool2d(kernel_size=4, stride=2, padding=1)
        # block 2
        self.bn2 = nn.BatchNorm2d(384, affine=False)
        self.conv2 = SoftHebbConv2d(in_channels=384, out_channels=768, kernel_size=3, padding=1, t_invert=0.65,)
        self.activ2 = Triangle(power=1.4)
        self.pool2 = nn.MaxPool2d(kernel_size=4, stride=2, padding=1)
        # block 3
        self.bn3 = nn.BatchNorm2d(768, affine=False)
        self.conv3 = SoftHebbConv2d(in_channels=768, out_channels=1536, kernel_size=3, padding=1, t_invert=0.25,)
